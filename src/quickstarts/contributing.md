...
## 3. Select a writable contributor checkout
...
## 4. Configure writable lookaside storage
...
## 6. Ingest and keep the checkout unchanged
...
## 7. Review and apply the overlay
...
## 9. Alternative: use a reviewed ingest recipe
